    ...
    return Scaffold(
      body: Column(
        children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            (() {
                              ...
                              return BigText(
                                  text: outputDate, size: Dimension.font20);
                            }()),
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          ...
                                          Get.find<CartController>().setItem =
                                              moreOder;
          ...
          //                                             image: DecorationImage(
          //                                               fit: BoxFit.cover,
          //                                               image: NetworkImage(AppConstants.BASE_URL + AppConstants.UPLOAD_IMG + getCartHistoryList[listCounter - 1].img!,
          //                                               ),
          //                                             ),
          //                                           ),
          //                                         )
